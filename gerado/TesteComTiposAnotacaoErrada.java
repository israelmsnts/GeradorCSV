...
public class TesteComTiposAnotacaoErrada {
	...
	public String toUpdate(){
	 	...
	 	String valores = "";
				...
				valores += ", nome = " + nome ; 
				where   += " and nome = " + toString(nome) ;
				valores += ", data_nascimento = " + dataNascimento ; 
				where   += " and data_nascimento = " + toString(dataNascimento) ;
		return (
				"update " + tabela + "set "
				+ valores.substring(1)
				+ " where 1=1 "
	...
	private String toString(Object o) {
		...
		if (!isNumeric(str) &&  !str.startsWith("'") &&  !str.startsWith("nextval") &&  !str.startsWith("now()") ){
				o1 = "'" + str + "'";
		}else {
				o1 = str;
		}
